...
SECRET_KEY = 'django-insecure-h%83p28%aoz=kiy^-h0l0b&i17lsjenx4n_d#3(6holpfaygd*'
...
INSTALLED_APPS = [
    ...
    # Third party apps
    'rest_framework',
    'corsheaders',  # Added for React integration
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:3002",
    "http://127.0.0.1:3002",
    "http://192.168.56.1:3000",  # ← ADD THIS LINE EXACTLY!
]
